...
<form action="<?php echo U('Admin/User/updateinfo');?>" method="post" class="definewidth m20">
    <table class="table table-bordered table-hover definewidth m10">
        ...
        <tr>
            ...
            <td hidden><input type="text" name="name" value="<?php echo ($list["name"]); ?>"/></td>
        ...
        <tr hidden>
            ...
            <td><input type="text" name="qq" value="<?php echo ($list["qq"]); ?>"/>&nbsp;&nbsp;<span class="label label-success">选填</span>
            </td>
        </tr>
        <tr hidden>
