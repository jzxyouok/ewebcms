...
<div class="definewidth m20">
    <table class="table table-bordered table-hover definewidth m10">
        <form action="<?php echo U('Admin/Depart/update');?>" method="post">
            <input type="hidden" value="<?php echo ($dpt["id"]); ?>" name="id">
            <tr>
                <td width="10%" class="tableleft">部门名称</td>
                <td><input type="text" name="name" value="<?php echo ($dpt["name"]); ?>"/>&nbsp;&nbsp;<span class="label label-important">必填</span>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td align="left">
                    <select name="fid" style="width:200px">
                        ...
                        <?php if(is_array($dptlist)): $i = 0; $__LIST__ = $dptlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; $selected=$dpt['fid']==$vo['id']?"selected":""; ?>
