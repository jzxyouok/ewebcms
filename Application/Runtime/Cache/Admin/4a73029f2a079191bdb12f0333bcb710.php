...
<form action="<?php echo U('Admin/Rbac/updateUser');?>" method="post" class="definewidth m20">
    <table class="table table-bordered table-hover definewidth m10">
        ...
        <tr>
            ...
            <td><select name="mid" style="width:200px">
                <?php if(is_array($roles)): $i = 0; $__LIST__ = $roles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; echo "111".$vo.id;$selected=$vo['id']==$list['mid']?"selected":""; ?>
