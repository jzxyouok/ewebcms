...
<form action="<?php echo U('Admin/Message/checkallOrdelall');?>" method="post">
    <table class="table table-bordered table-hover definewidth m10">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td>
                    ...
                    <?php if($vo["display"] == 0): ?><span class="label label-important">不可见</span>
                        <?php else: ?>
                ...
                <td>
                    ...
                    <?php if($vo["display"] == 0): ?><button type="button" class="btn btn-mini btn-primary" onclick="javasript:check(<?php echo ($vo["id"]); ?>)">
                            审核
                        </button><?php endif; ?>
    ...
    <div class="row">
        <div>
            ...
            <input type="submit" class="btn btn-small btn-success" name="checkall" value="全部审核通过">
            <input type="submit" class="btn btn-small btn-inverse" name="checknone" value="取消审核">
