...
<div class="navbar definewidth m10">
    <div class="navbar-inner">
        <a class="brand">留言列表</a>&nbsp;&nbsp;<a class="brand">共有<?php echo ($count); ?>条</a>
    </div>
</div>
<form action="" method="post">
    <table class="table table-bordered table-hover definewidth m10">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td><?php echo (msubstr($vo["content"],0,30,'utf8',true)); ?></td>
                <td><?php echo (date("Y-m-d H:i",$vo["date"])); ?></td>
                <td><?php echo (msubstr($vo["reply"],0,30,'utf8',true)); ?></td>
                <td>
...
<script>
    function del(id) {
        ...
        if (confirm("确定要删除吗？")) {
            window.location.href = "<?php echo ($delurl); ?>?openid=" + id;
