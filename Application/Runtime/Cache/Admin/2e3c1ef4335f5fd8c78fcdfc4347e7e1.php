...
<div class="definewidth m10">
    <div class="navbar definewidth m10" style="margin-bottom:-8px;">
        <div class="navbar-inner">
            <a class="brand">新导航添加</a>
        </div>
    </div>
</div>
<form action="<?php echo U('Admin/NewsClass/navaddsubmit');?>" method="post" class="definewidth m20">
    <table class="table table-bordered table-hover definewidth m10">
        ...
        <tr>
            ...
            <td><textarea name="remark" id="remark" cols="30" rows="5"></textarea>&nbsp;&nbsp;<span
