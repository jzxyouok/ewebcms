...
<div class="definewidth m20">
    <table class="table table-bordered table-hover definewidth m10">
        <form id="mainform" action="<?php echo U('Admin/NewsClass/addpage');?>" method="post">
            <tr>
        ...
        <form id="form1" action="<?php echo U('Admin/NewsClass/addsubmit',array('type' => 3));?>" method="post">
