...
<div class="definewidth m20">
    <table class="table table-bordered table-hover definewidth m10">
        ...
        <form id="mainform" action="<?php echo U('Admin/NewsClass/edit');?>?typeid=1" method="post">
        ...
        <form action="<?php echo U('Admin/NewsClass/update');?>?type=1" method="post" class="definewidth m20">
