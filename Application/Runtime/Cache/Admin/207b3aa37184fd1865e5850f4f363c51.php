...
<form action="<?php echo U('Admin/Rbac/updateRole');?>" method="post" class="definewidth m20 form">
    <input type="hidden" name="id" value="<?php echo ($role["id"]); ?>"/>
    <table class="table table-bordered table-hover definewidth m10">
        <tr>
            <td width="10%" class="tableleft">角色名称</td>
            <td><input type="text" name="name" value="<?php echo ($role["name"]); ?>"/></td>
        </tr>
        <tr>
            <td width="10%" class="tableleft">角色描述</td>
            <td><input type="text" name="remark" value="<?php echo ($role["remark"]); ?>"/></td>
        </tr>
        <tr>
