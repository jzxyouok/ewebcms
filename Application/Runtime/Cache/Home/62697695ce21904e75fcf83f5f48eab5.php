...
<div class="list_center">
    ...
    <?php if(is_array($msglist)): $i = 0; $__LIST__ = $msglist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="messagebox">
            <div class="question">
                <div class="from">
                    <b>"<?php echo ($vo["name"]); ?>"</b> &nbsp;于&nbsp;<?php echo (date("Y-m-d",$vo["date"])); ?>&nbsp;留言:&nbsp;&nbsp;&nbsp;&nbsp; <b>标题:</b>&nbsp;<?php echo ($vo["title"]); ?>
                </div>
                <?php echo ($vo["content"]); ?>
            </div>
            <div class="reply">
                <div class="from">
                    <?php echo (date("Y-m-d",$vo["replydate"])); ?>&nbsp;回复:
                </div>
                <?php echo ($vo["reply"]); ?>
            </div>
